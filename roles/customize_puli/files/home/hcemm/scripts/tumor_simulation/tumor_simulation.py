...
with open(log_file, "w") as f:
    f.write(f"{Fore.CYAN}Starting tumor simulation for Patient {patient_id}{Style.RESET_ALL}\n")
...
with open(log_file, "a") as f:
    f.write(f"{Fore.YELLOW}Patient {patient_id} simulation complete ✅{Style.RESET_ALL}\n")
